 ...
 * @LastEditTime: 2021-06-05 17:35:20
      ...
      <ol>
        <li class="item">
          <div class="proDesc">
            <input type="checkbox" />
            <a href="" class="img">
              <img src="../../assets/img/cs.jpg" alt="" />
            </a>
            <div class="info">
              <div class="txt1">MIX FOLD 小米折叠屏手机 12GB+256GB 黑色</div>
              <div class="txt2"><span>售价：</span><span>9999元</span></div>
              <div class="caozuo">
